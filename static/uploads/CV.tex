...
&\href{https://yeabinmoon.netlify.app/}{Personal Website}\\
\end{tabular}
...
\item[] {Ph.D. }, Economics, 2021 (expected)
...
\section{Job Market Paper}
	 ...
	 \href{https://www.icloud.com/iclouddrive/0u3czhnN1eXC5-5H5qUlaxO2Q#draft4}{Long Term Effects of Graduating in a Recession for Economics Ph.D.s}
...
%\textbf{Microeconomics Seminar Series} \hfill {2021 October}
%\begin{innerlist}
...
%\vspace{-.1275in}
\begin{bibsection}
   \item {\bf Moon, Y.}, ``Long Term Effects of Graduating in a Recession for Economics Ph.D.s" \emph{Microeconomics Seminar Series}, Department of Economics, University of Houston, 2021.
...
\section{Awards}
%Best Graduate Student Teaching Award, University of Houston, Department of Economics% \hfill 2021
\textbf{Best Graduate Instructor} \hfill {2021}
\begin{innerlist}
	\item[] Department of Economics,\\
	University of Houston \\
	%Supervisors: Elaine M. Liu, Ph.D
\end{innerlist}
...
Referee --- Economic Inquiry \hfill 2021

\halfblankline

\section{Skills}

Python, MATLAB, Stata, \LaTeX{}, Git, SQL
...
\begin{innerlist}
	...
	\item[] Department of Economics,\\
	University of Illinois at Urbana-Champaign\\
	Supervisors: Kristine M. Brown, Ph.D
\end{innerlist}
\textbf{Research Assistant} \hfill {2012 Summer}
\begin{innerlist}
	
	\item[] Department of Economics,\\
	University of Illinois at Urbana-Champaign\\
	Supervisors: Fred M. Gottheil, Ph.D
\end{innerlist}
...
\begin{innerlist}
	...
	University of Illinois at Urbana-Champaign\\
	Supervisors: Nathan Dunfield, Ph.D
\end{innerlist}
...
\begin{innerlist}
	...
	University of Illinois at Urbana-Champaign\\
	Supervisors: Laura A. Hastings, Ph.D
\end{innerlist}
\halfblankline
