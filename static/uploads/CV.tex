...
\item[] {Ph.D. }, Economics, 2017 -- 2021 (expected)
...
\begin{innerlist}
	\vspace{1 mm}
	\item \textit{This award is given annually to a fifth-graduate students doing an exceptional job of teaching}
...
\textbf{Referee} --- Economic Inquiry \hfill 2021
...
\textbf{Contributor} \hfill {2020}
\begin{innerlist}
	\item[] ClinIQ Health,\\
	Supervisors: Ajintha Pathmanathan, M.D.
	\begin{innerlist}
	...
	\end{innerlist}
\end{innerlist}
\textbf{Academic Researcher}, SafeGraph \hfill {2019 - present}\\
