...
\begin{innerlist}
	\vspace{1 mm}
	\item \textit{This award is given annually to a fifth-year graduate student who have shown excellence as a teaching assistant or instructor in the undergraduate economics program}
\end{innerlist}
%\halfblankline
...
\begin{innerlist}
	...
	\end{innerlist}
\end{innerlist}
\textbf{Academic Researcher} \hfill {2019 - present}
\begin{innerlist}
	\item []SafeGraph
	\begin{innerlist}
		\item Using the cellphone tracking data construct the Covid-19 exposure rate of each county in US 
	\end{innerlist}
\end{innerlist}
...
\begin{innerlist}
	...
	\begin{innerlist}
		\item Visualization of Hyperbolic 3-Manifolds
	\end{innerlist}
\end{innerlist}
